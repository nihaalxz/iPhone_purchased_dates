...
result_.innerHTML=`<h3>Total number of days Ntorq purchased is </h3><h1 style="font-size:140px">${Difference_In_Days_}</h1>`;
...
result__.innerHTML=`<h3>Total number of days HP victus purchased is </h3><h1 style="font-size:140px">${Difference_In_Days__}</h1>`;
