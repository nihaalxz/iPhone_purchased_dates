...
result.innerHTML = `<h3>Total number of days iPhone owned:</h3><h1 style="font-size:53px">${Difference_In_Days}</h1>`;
...
result_.innerHTML = `<h3>Total number of days Ntorq owned:</h3><h1 style="font-size:53px">${Difference_In_Days_}</h1>`;
...
result__.innerHTML = `<h3>Total number of days HP victus owned:</h3><h1 style="font-size:53px">${Difference_In_Days__}</h1>`;
